...
const CustomeLink = ({ to, title, className }) => {
  return (
    <Link
      href={to}
      className={
        "hero-btn group w-fit  flex items-center  justify-between gap-2 active:animate-ping bg-slate-50  hover:bg-slate-900  px-5 py-3    border-b-2  border-t-2  hover:border-blue-500  rounded-3xl transition duration-300 ease-linear text-sm text-slate-900  hover:text-white md:text-base " +
        className
      }>
